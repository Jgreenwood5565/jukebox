...
class ApiQueueTest(ApiTestBase):
    ...
    def testAddAndIndex(self):
        ...
        # add to queue
        response = self.httpPost("/api/v1/queue", {"id": song.id})
    ...
    def addToQueue(self, song):
        return self.httpPost("/api/v1/queue", {"id": song.id})
    ...
    def testIndexOrderByTitle(self):
        ...
        result = json.loads(self.httpGet("/api/v1/queue?order_by=title").content)
        ...
        result = json.loads(
            self.httpGet("/api/v1/queue?order_by=title&order_direction=desc").content
        )
    ...
    def testIndexOrderByArtist(self):
        ...
        result = json.loads(self.httpGet("/api/v1/queue?order_by=artist").content)
        ...
        result = json.loads(
            self.httpGet("/api/v1/queue?order_by=artist&order_direction=desc").content
        )
    ...
    def testIndexOrderByAlbum(self):
        ...
        result = json.loads(self.httpGet("/api/v1/queue?order_by=album").content)
        ...
        result = json.loads(
            self.httpGet("/api/v1/queue?order_by=album&order_direction=desc").content
        )
    ...
    def testIndexOrderByYear(self):
        ...
        result = json.loads(self.httpGet("/api/v1/queue?order_by=year").content)
        ...
        result = json.loads(
            self.httpGet("/api/v1/queue?order_by=year&order_direction=desc").content
        )
    ...
    def testIndexOrderByGenre(self):
        ...
        result = json.loads(self.httpGet("/api/v1/queue?order_by=genre").content)
        ...
        result = json.loads(
            self.httpGet("/api/v1/queue?order_by=genre&order_direction=desc").content
        )
    ...
    def testIndexOrderByCreated(self):
        ...
        result = json.loads(self.httpGet("/api/v1/queue?order_by=created").content)
        ...
        result = json.loads(
            self.httpGet("/api/v1/queue?order_by=created&order_direction=desc").content
        )
    ...
    def testCount(self):
        ...
        result = json.loads(self.httpGet("/api/v1/queue?count=1").content)
        self.assertEqual(len(result["itemList"]), 1)
        self.assertEqual(result["itemList"][0]["id"], song_a.id)
        self.assertTrue(result["hasNextPage"])

        result = json.loads(self.httpGet("/api/v1/queue?count=3").content)
    ...
    def testCountAndPage(self):
        ...
        result = json.loads(self.httpGet("/api/v1/queue?count=1&page=1").content)
        self.assertEqual(len(result["itemList"]), 1)
        self.assertEqual(result["itemList"][0]["id"], song_a.id)
        self.assertTrue(result["hasNextPage"])

        result = json.loads(self.httpGet("/api/v1/queue?count=1&page=2").content)
        self.assertEqual(len(result["itemList"]), 1)
        self.assertEqual(result["itemList"][0]["id"], song_b.id)
        self.assertTrue(result["hasNextPage"])

        result = json.loads(self.httpGet("/api/v1/queue?count=1&page=3").content)
        self.assertEqual(len(result["itemList"]), 1)
